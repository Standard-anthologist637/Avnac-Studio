...
import VectorBoardListPreview from "@/components/editor/vector-boards/vector-board-list-preview";
...
export default function EditorVectorBoardPanel({
  ...
  return (
    <div
      data-avnac-chrome
      className={[
        "pointer-events-auto fixed z-[90] flex w-[min(100vw-1.5rem,300px)] flex-col overflow-hidden rounded-3xl border border-black/[0.08] bg-white/95 backdrop-blur-md",
        editorSidebarPanelLeftClass,
        editorSidebarPanelTopClass,
      ].join(" ")}
      role="dialog"
                  ...
                  <div className="flex items-center gap-2 rounded-xl border border-black/[0.06] bg-neutral-50/80 p-2">
                    ...
                    >
                      ...
                      <span className="mt-0.5 block text-[11px] text-neutral-500">
                        {hasContent
                          ? "Click to edit · drag preview to place"
                          : "Click to edit"}
                      </span>
                    </button>
                    <button
